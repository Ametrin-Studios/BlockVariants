    ...
    protected  <B extends Block> void blocks(List<B> blocks){
        for(B block : blocks) {
            ...
            if(block instanceof StairBlock){
                ...
                if(shouldAppendS(textureName)) {texture = blockTexture(textureName.replace("_stairs", "s"));}
                ...
                if(shouldAppendS(textureName)) {texture = blockTexture(textureName.replace("_slab", "s"));}
                else if(textureName.contains("chiseled_quartz")) {
