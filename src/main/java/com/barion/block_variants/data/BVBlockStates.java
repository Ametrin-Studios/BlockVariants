...
public class BVBlockStates extends BlockStateProvider {
    ...
    protected void regAll(RegistryObject<StairsBlock> stairs, RegistryObject<SlabBlock> slab, RegistryObject<WallBlock> wall, String texture, String topTexture){
        regStairs(stairs, texture, topTexture);
        regSlab(slab, texture, topTexture, texture);
        regWall(wall, texture);
    }
    protected void regAll(RegistryObject<StairsBlock> stairs, RegistryObject<SlabBlock> slab, RegistryObject<WallBlock> wall, String texture, String topTexture, String doubleSlab){
        regStairs(stairs, texture, topTexture);
        regSlab(slab, texture, topTexture, doubleSlab);
        regWall(wall, texture);
    }
    protected void regStairsSlab(RegistryObject<StairsBlock> stairs, RegistryObject<SlabBlock> slab, String texture, String topTexture){
        regStairs(stairs, texture, topTexture);
        regSlab(slab, texture, topTexture, texture);
    }
    protected void regStairs(RegistryObject<StairsBlock> stairs, String texture){
        stairsBlock(stairs.get(), mcLoc("block/" + texture));
    }
    protected void regStairs(RegistryObject<StairsBlock> stairs, String texture, String topTexture){
