...
public class BVRecipes extends RecipeProvider {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer){
        ...
        recipeSmelting(BVBlocks.Smooth_Basalt_Stairs.get().asItem(), BVBlocks.Basalt_Stairs.get().asItem());
        recipeSmelting(BVBlocks.Smooth_Basalt_Slab.get().asItem(), BVBlocks.Basalt_Slab.get().asItem());
    ...
    protected void recipeSlab(Item slab, Item material) {recipeSlab(slab, material, true);}
    ...
    protected void recipeStonecutting(Item result, Item ingredient) {recipeStonecutting(result, ingredient, 1);}
    ...
    private static ResourceLocation recipeID(Item item) { return new ResourceLocation(BlockVariants.ModID, item.toString());}
    private static ResourceLocation recipeID(Item item, String add) { return new ResourceLocation(BlockVariants.ModID, item.toString() + add);}
}